...
import (
	...
	app_blocklist "veda-anchor-agent/src/internal/blocklist/app"
	"veda-anchor-agent/src/internal/config"
	"veda-anchor-agent/src/internal/data/history"
	"veda-anchor-agent/src/internal/monitoring"
	"veda-anchor-agent/src/internal/platform/autostart"
	"veda-anchor-agent/src/internal/platform/nativehost"
	"veda-anchor-agent/src/internal/platform/proc_sensing"
	"veda-anchor-agent/src/internal/platform/uninstall"
